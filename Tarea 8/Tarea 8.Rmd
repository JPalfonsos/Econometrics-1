...
print(-1.645-0.0887)
```
Cuando la persona es de raza blanca y esto es la única variable que se tiene en cuenta, se afirma que ser blanco hace que la probabilidad de que viole los términos de la libertad bajo fianza varie -1.7337, verlo de esta forma implica bias de racismo, pero es estadísticamente significativo.
